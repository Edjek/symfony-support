...
-   [1. Comprendre les fondamentaux du développement web :](#1-comprendre-les-fondamentaux-du-développement-web-)
-   [2. Maîtriser les principes du framework Symfony :](#2-maîtriser-les-principes-du-framework-symfony-)
-   [3. Créer des applications Symfony :](#3-créer-des-applications-symfony-)
-   [4. Gérer la persistance des données :](#4-gérer-la-persistance-des-données-)
-   [5. Utiliser les services et les dépendances :](#5-utiliser-les-services-et-les-dépendances-)
-   [6. Mettre en œuvre la sécurité :](#6-mettre-en-œuvre-la-sécurité-)
-   [7. Développer des fonctionnalités avancées :](#7-développer-des-fonctionnalités-avancées-)
-   [8. Tester les applications Symfony :](#8-tester-les-applications-symfony-)
-   [9. Déployer et maintenir des applications :](#9-déployer-et-maintenir-des-applications-)
-   [10. Projet pratique :](#10-projet-pratique-)
