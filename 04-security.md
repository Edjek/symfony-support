# 🚀 [Symfony](https://symfony.com/) | Authentication Guide
...
-   [4. Création d'un Formulaire de Connexion](#4-création-dun-formulaire-de-connexion)
    -   [Explication](#explication-1)
-   [5. Création d'un Formulaire d'Inscription](#5-création-dun-formulaire-dinscription)
